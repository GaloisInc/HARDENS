...
w3 Generate_Sensor_Trips(w32 vals4794[3], w32 setpoints4795[3])
{
    w1 app_4113;
    w1 app_4114;
    w1 app_4115;
    w3 return_4101;
    return_4101 = 0;
    app_4113 = Trip(vals4794, setpoints4795, (w2) 0);
    app_4114 = Trip(vals4794, setpoints4795, (w2) 1);
    app_4115 = Trip(vals4794, setpoints4795, (w2) 2);
    if (app_4113)
    {
...
w1 Trip(w32 vals4789[3], w32 setpoints4790[3], w2 ch4791)
{
    w1 app_4098;
    w1 app_4099;
    w1 app_4100;
    ...
    w1 return_4096;
    return_4096 = 0;
    app_4100 = ch4791 == (w2) 2;
    if (app_4100)
    {
        app_4098 = (signed _ExtInt(32)) vals4789[ch4791] < (signed _ExtInt(32)) setpoints4790[ch4791];
        ifv_4097 = app_4098;
    }
    else
    {
        app_4099 = setpoints4790[ch4791] < vals4789[ch4791];
        ifv_4097 = app_4099;
    }
