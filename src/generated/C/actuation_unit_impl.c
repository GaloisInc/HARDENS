...
w1 Actuate_D0(w8 trips4830[3][4], w1 old4831)
{
    w1 app_4127;
    w1 app_4128;
    w1 app_4129;
    ...
    w1 return_4115;
    return_4115 = 0;
    app_4127 = Coincidence_2_4(trips4830[(w2) 0]);
    app_4128 = Coincidence_2_4(trips4830[(w2) 1]);
    app_4129 = app_4127 | app_4128;
    app_4130 = app_4129 | old4831;
    return_4115 = app_4130;
    return return_4115;
}
w1 Actuate_D1(w8 trips4826[3][4], w1 old4827)
{
    w1 app_4135;
    w1 app_4136;
    w1 return_4132;
    return_4132 = 0;
    app_4135 = Coincidence_2_4(trips4826[(w2) 2]);
    app_4136 = app_4135 | old4827;
    return_4132 = app_4136;
    return return_4132;
}
w1 Coincidence_2_4(w8 x4850[4])
{
    w1 app_4098;
    w1 app_4099;
    w1 app_4100;
    ...
    w1 return_4097;
    return_4097 = 0;
    app_4098 = x4850[(w2) 0] != (w8) 0;
    app_4099 = x4850[(w2) 1] != (w8) 0;
    app_4100 = app_4098 & app_4099;
    app_4101 = x4850[(w2) 0] != (w8) 0;
    app_4102 = x4850[(w2) 1] != (w8) 0;
    app_4103 = app_4101 | app_4102;
    app_4104 = x4850[(w2) 2] != (w8) 0;
    app_4105 = x4850[(w2) 3] != (w8) 0;
    app_4106 = app_4104 | app_4105;
    app_4107 = app_4103 & app_4106;
    app_4108 = x4850[(w2) 2] != (w8) 0;
    app_4109 = x4850[(w2) 3] != (w8) 0;
