...
w2 Voting_Step(w3 inp4792[4])
{
    ...
    {
        arrv_4127 |= (w4) (inp4792[(w32) 0] >> (w2) 0 & 1) << 0;
    }
    else
    {
        arrv_4127 &= ~((w4) 1 << 0);
    ...
    {
        arrv_4127 |= (w4) (inp4792[(w32) 1] >> (w2) 0 & 1) << 1;
    }
    else
    {
        arrv_4127 &= ~((w4) 1 << 1);
    ...
    {
        arrv_4127 |= (w4) (inp4792[(w32) 2] >> (w2) 0 & 1) << 2;
    }
    else
    {
        arrv_4127 &= ~((w4) 1 << 2);
    ...
    {
        arrv_4127 |= (w4) (inp4792[(w32) 3] >> (w2) 0 & 1) << 3;
    }
    else
    {
        arrv_4127 &= ~((w4) 1 << 3);
    ...
    {
        arrv_4129 |= (w4) (inp4792[(w32) 0] >> (w2) 1 & 1) << 0;
    }
    else
    {
        arrv_4129 &= ~((w4) 1 << 0);
    ...
    {
        arrv_4129 |= (w4) (inp4792[(w32) 1] >> (w2) 1 & 1) << 1;
    }
    else
    {
        arrv_4129 &= ~((w4) 1 << 1);
    ...
    {
        arrv_4129 |= (w4) (inp4792[(w32) 2] >> (w2) 1 & 1) << 2;
    }
    else
    {
        arrv_4129 &= ~((w4) 1 << 2);
    ...
    {
        arrv_4129 |= (w4) (inp4792[(w32) 3] >> (w2) 1 & 1) << 3;
    }
    else
    {
        arrv_4129 &= ~((w4) 1 << 3);
    ...
    {
        arrv_4132 |= (w4) (inp4792[(w32) 0] >> (w2) 2 & 1) << 0;
    }
    else
    {
        arrv_4132 &= ~((w4) 1 << 0);
    ...
    {
        arrv_4132 |= (w4) (inp4792[(w32) 1] >> (w2) 2 & 1) << 1;
    }
    else
    {
        arrv_4132 &= ~((w4) 1 << 1);
    ...
    {
        arrv_4132 |= (w4) (inp4792[(w32) 2] >> (w2) 2 & 1) << 2;
    }
    else
    {
        arrv_4132 &= ~((w4) 1 << 2);
    ...
    {
        arrv_4132 |= (w4) (inp4792[(w32) 3] >> (w2) 2 & 1) << 3;
    }
    else
    {
        arrv_4132 &= ~((w4) 1 << 3);
