...
w2 Voting_Step(w8 inp4799[4][3], w2 old_votes4800)
{
    w1 app_4140;
    w1 app_4141;
    w1 app_4142;
    ...
    w2 return_4107;
    return_4107 = 0;
    app_4140 = inp4799[(w32) 0][(w2) 0] == (w8) 1;
    app_4141 = inp4799[(w32) 1][(w2) 0] == (w8) 1;
    app_4142 = inp4799[(w32) 2][(w2) 0] == (w8) 1;
    app_4143 = inp4799[(w32) 3][(w2) 0] == (w8) 1;
    arrv_4139 = 0;
    if (app_4140)
    {
    ...
    app_4146 = inp4799[(w32) 0][(w2) 1] == (w8) 1;
    app_4147 = inp4799[(w32) 1][(w2) 1] == (w8) 1;
    app_4148 = inp4799[(w32) 2][(w2) 1] == (w8) 1;
    app_4149 = inp4799[(w32) 3][(w2) 1] == (w8) 1;
    arrv_4145 = 0;
    if (app_4146)
    {
    ...
    app_4151 = app_4150 | old_votes4800 >> (w1) 0 & 1;
    app_4152 = app_4144 | app_4151;
    app_4154 = inp4799[(w32) 0][(w2) 2] == (w8) 1;
    app_4155 = inp4799[(w32) 1][(w2) 2] == (w8) 1;
    app_4156 = inp4799[(w32) 2][(w2) 2] == (w8) 1;
    app_4157 = inp4799[(w32) 3][(w2) 2] == (w8) 1;
    arrv_4153 = 0;
    if (app_4154)
    {
    ...
    app_4159 = app_4158 | old_votes4800 >> (w1) 1 & 1;
    if (app_4152)
    {
