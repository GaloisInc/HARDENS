...
w3 Generate_Sensor_Trips(w32 vals4740[3], w32 setpoints4741[3])
{
    w1 app_4100;
    w1 app_4101;
    w1 app_4102;
    ...
    if (app_4102)
    {
        app_4100 = vals4740[(w2) 0] < setpoints4741[(w2) 0];
        ifv_4099 = app_4100;
    }
    else
    {
        app_4101 = setpoints4741[(w2) 0] < vals4740[(w2) 0];
        ifv_4099 = app_4101;
    }
    app_4107 = (w2) 1 == (w2) 2;
    if (app_4107)
    {
        app_4105 = vals4740[(w2) 1] < setpoints4741[(w2) 1];
        ifv_4104 = app_4105;
    }
    else
    {
        app_4106 = setpoints4741[(w2) 1] < vals4740[(w2) 1];
        ifv_4104 = app_4106;
    }
    app_4112 = (w2) 2 == (w2) 2;
    if (app_4112)
    {
        app_4110 = vals4740[(w2) 2] < setpoints4741[(w2) 2];
        ifv_4109 = app_4110;
    }
    else
    {
        app_4111 = setpoints4741[(w2) 2] < vals4740[(w2) 2];
        ifv_4109 = app_4111;
    }
    if (ifv_4099)
    {
...
w1 Is_Ch_Tripped(w2 mode4736, w1 sensor_tripped4737)
{
    w1 app_4114;
    w1 app_4115;
    w1 app_4116;
    ...
    w1 return_4113;
    return_4113 = 0;
    app_4114 = mode4736 == (w2) 2;
    app_4115 = mode4736 == (w2) 1;
    app_4116 = app_4115 & sensor_tripped4737;
