...
w3 Generate_Sensor_Trips(w32 vals4761[3], w32 setpoints4762[3])
{
    w1 app_4100;
    w1 app_4101;
    w1 app_4102;
    ...
    if (app_4102)
    {
        app_4100 = vals4761[(w2) 0] < setpoints4762[(w2) 0];
        ifv_4099 = app_4100;
    }
    else
    {
        app_4101 = setpoints4762[(w2) 0] < vals4761[(w2) 0];
        ifv_4099 = app_4101;
    }
    app_4107 = (w2) 1 == (w2) 2;
    if (app_4107)
    {
        app_4105 = vals4761[(w2) 1] < setpoints4762[(w2) 1];
        ifv_4104 = app_4105;
    }
    else
    {
        app_4106 = setpoints4762[(w2) 1] < vals4761[(w2) 1];
        ifv_4104 = app_4106;
    }
    app_4112 = (w2) 2 == (w2) 2;
    if (app_4112)
    {
        app_4110 = vals4761[(w2) 2] < setpoints4762[(w2) 2];
        ifv_4109 = app_4110;
    }
    else
    {
        app_4111 = setpoints4762[(w2) 2] < vals4761[(w2) 2];
        ifv_4109 = app_4111;
    }
    if (ifv_4099)
    {
